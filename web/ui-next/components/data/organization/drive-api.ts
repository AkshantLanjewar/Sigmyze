...
async function DeleteProject(token: string, organization_id: string, parent: string, id: string) {
    let body = {
        project_id: id,
        parent_folder: parent,
        organization_id: organization_id
...
async function UpdateProject(token: string, organization_id: string, parent: string, id: string, name?: string) {
    let body = {
        project_id: id,
        parent_folder: parent,
        organization_id: organization_id
