...
pub async fn set_output_value(socket_data: String, process_id: String, data_store: &web::Data<Basteh>) -> Result<messages::SocketResponse> {
    ...
    Ok(socket_response(String::from("set_value"), false))
}

pub async fn get_output_value(socket_data: String, process_id: String, data_store: &web::Data<Basteh>) -> Result<messages::SocketResponse> {
    ...
    Ok(socket_response(serde_json::to_string(&data)?, false))
}