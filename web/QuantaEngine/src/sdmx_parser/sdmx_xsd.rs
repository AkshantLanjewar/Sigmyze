                ...
                match tag_name {
                    "simpleType" => {
                        ...
                        for attribute in e.attributes().into_iter() {
                            ...
                            if attr_name.as_ref() == b"name" {
                               field_name = Some(String::from_utf8(attribute.value.as_ref().to_vec()).unwrap());
                            }
                        } 
                    ...
                    "complexType" => {
                        ...
                        for attribute in e.attributes().into_iter() {
                            ...
                            if attr_name.as_ref() == b"name" {
                                series_name = Some(String::from_utf8(attribute.value.as_ref().to_vec()).unwrap());
                            }
                        }
                    ...
                    "enumeration" => {
                        ...
                        for attribute in e.attributes().into_iter() {
                            ...
                            if attr_name.as_ref() == b"value" {
                                field_value = Some(String::from_utf8(attribute.value.as_ref().to_vec()).unwrap());
                            }
                        }
