          ...
          <table className='aboutTable'>
            ...
            <tr>
              ...
              <td>
                ...
                <p style={{marginTop:'3px'}}>
                  Attribution: Sourced from World Economic Outlook published by the IMF (International Monetary Fund).
                </p>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                ...
                <p style={{marginTop:'3px', fontStyle:'italic', fontSize:'0.6rem'}}>Attribution: JHU CSSE COVID-19 Data (https://github.com/CSSEGISandData/COVID-19)</p>
              </td>
              <td>
                <p>Daily</p>
              </td>
