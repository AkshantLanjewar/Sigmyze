    ...
    <div>
      ...
      <div className='aboutBody'>
        ...
        <div style={{marginBottom:'50px'}}>
          ...
          <p className='aboutPara'>
            Akshant Lanjewar - tech and coding geek, intrepid taekwondo learner, and high school senior. Dabbled in building a gaming PC and personal coding projects using React, HTML, JS, NodeJS, Express, C++, Python, etc.
          </p>
          <p className='aboutPara'>
