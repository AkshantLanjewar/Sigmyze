...
import ChartIcons from "../../../u-pages/chart-builder/components/add-modal/charticons"
...
function IndicatorList(props) {
    ...
    useEffect(() => {
        ...
        for(let i = 0; i < categoryNames.length; i++) {
            ...
            let indicatorUrl = `/api/data/v2map/datasets/${activeDataset.name}/categories/${category.name}`
            //api/${datatype}/getMapData/${category}/getMetrics/
